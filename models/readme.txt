...
Run the following commands(if needed) before generating models using tensorflow.
...
Run the following commands in this(./models) directory.
...
$ python3 -m tf2onnx.convert --saved-model ./<net_name> --output ../nets/<dataset-name>/<netname>.onnx
	Example: python3 -m tf2onnx.convert --saved-model ./net3 --output ../nets/mnist/net3.onnx
